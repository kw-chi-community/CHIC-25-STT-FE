        ...
        <section id="imageType" className={`imageType__wrap ${props.element}`}>
            ...
            <div className="image__inner container">
                <article className="image img1">
                    ...
                    <p className="image__desc">지난 회의 내용을 한눈에 확인하고, <br />중요한 논의 사항을 빠르게 찾아보세요.</p>
                    <a className="image__btn" href="/">날짜별로 보기</a>
                </article>
                <article className="image img2">
                    <h3 className="image__title">주제별 회의록 확인하기</h3>
                    <p className="image__desc">회의 내용을 주제별로 정리하여 빠르게 찾아볼 수 있습니다. <br /> 원하는 주제를 선택하고 회의록을 확인하세요.</p>
